	...
	$(function(){
		...
		buttons.click(function(){
			...
			if($this.is('#pink')){
				//aca van a ir los rangos para los de color rosa
		...
		(function(){
			...
			xhr.open('GET', '../img/img1.jpg', true);
			...
			xhr2.open('GET', '../img/img2.jpg', true);
			...
			$('#example-images').click(function(){
				...
				$('#dropzone1').html('<img src="../img/img1.jpg"/>');
				$('#dropzone2').html('<img src="../img/img2.jpg"/>');

				$.when(done, dtwo).done(function(file, file1){
					if (typeof FileReader === 'undefined') {
						resembleControl = resemble('../img/img1.jpg').compareTo('../img/img2.jpg').onComplete(onComplete);
					} else {
						resembleControl = resemble(file).compareTo(file1).onComplete(onComplete);
					}
				});
