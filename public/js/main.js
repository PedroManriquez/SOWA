$(function(){
	...
	(function(){
		...
		xhr.open('GET', '../img/People.jpg', true);
		...
		xhr2.open('GET', '../img/People2.jpg', true);
		...
		$('#example-images').click(function(){
			...
			$('#dropzone1').html('<img src="../img/People.jpg"/>');
			$('#dropzone2').html('<img src="../img/People2.jpg"/>');

			$.when(done, dtwo).done(function(file, file1){
				if (typeof FileReader === 'undefined') {
					resembleControl = resemble('../img/People.jpg').compareTo('../img/People2.jpg').onComplete(onComplete);
				} else {
					resembleControl = resemble(file).compareTo(file1).onComplete(onComplete);
				}
			});
